...
const managementsColumns: ReadonlyArray<Column<Role>> = [
  {
  ...
  {
    Header: (props) => (
      <CustomHeader tableProps={props} title='permissions' className='min-w-125px' />
    ),
    id: 'permissions',
    Cell: ({...props}) => <MultipleCell row={props.data[props.row.index].permissions} key={`row-${props.row.index}`} />,
  },
  {
    Header: (props) => (
